...
async function main() {
  ...
  if (args.length === 0) {
    console.error("Usage: tsx analyze-workflows-enhanced.ts <path-to-workflows.ts> [options]");
    console.error("Example: tsx analyze-workflows-enhanced.ts ./examples/blog-writer/src/workflows.ts");
    console.error("");
  ...
  try {
    ...
    // Output results
    console.log("🔍 Enhanced Workflow Analysis Results");
