...
GenSX is a TypeScript cloud platform for building and deploying complex AI applications. It combines a workflow framework for building agents, chatbot APIs, and RAG applications with a serverless deployment platform and zero-configuration cloud storage.
...
GenSX provides a complete platform for AI application development and deployment:
...
The platform is optimized for AI workloads with millisecond cold starts and support for long-running executions up to an hour.

### Development Server

Test your workflows locally with a development server that matches the cloud environment:
...
Build stateful AI applications with zero configuration using built-in storage primitives:
