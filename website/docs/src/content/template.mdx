...
GenSX provides several templates to help you get up and running quickly. This guide will walk you through cloning and deploying one of the GenSX app templates.
...
The [Client Side Tools template](https://github.com/gensx-inc/client-side-tools-template) is an app demonstrating how to call tools on the client side to build interactive apps. It features an
...
You can deploy the GenSX workflows by running the following command::
