---
title: Anthropic components
description: Anthropic API compatible component reference
---

# Anthropic Components

The [@gensx/anthropic](https://www.npmjs.com/package/@gensx/anthropic) package provides Anthropic API compatible components for GenSX.
