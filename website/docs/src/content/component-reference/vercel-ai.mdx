---
title: Vercel AI SDK components
description: Vercel AI SDK compatible component reference
---

# Vercel AI SDK Components

The [@gensx/vercel-ai-sdk](https://www.npmjs.com/package/@gensx/vercel-ai-sdk) package provides Vercel AI SDK compatible components for GenSX, allowing you to use Vercel's AI SDK with GenSX's component model.
