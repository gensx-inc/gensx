...
export default function TermsOfUse() {
  return (
    <div className="container mx-auto px-4 py-24 max-w-4xl">
      GenSX TERMS OF USE Effective 2024-09-12 ‍ These Terms of Use constitute a
      legally binding agreement made between you, whether personally or on
      behalf of an entity ("you") and GenSX, Inc. ("Company", "we", or "our")
      concerning your access to and use of the GenSX website (collectively, the
      "Site"). We are incorporated in Delaware, United States and have our
      principal office at 113 Cherry St., PMB 30368, Seattle, WA, 98104-2205,
      United States. You agree that by accessing the Site, you have read,
      ...
      granted to you in and to the Site, the Content and the Marks. ‍ By using
      the Site, you represent and warrant that: (1) you have the legal capacity
      ...
      purpose; and (5) your use of the Site will not violate any applicable law
      or regulation. If you provide any information that is untrue, inaccurate,
      not current, or incomplete, or otherwise violate these Terms of Use, we
      have the right to suspend or terminate your account and refuse any and all
      current or future use of the Site (or any portion thereof). ‍ You may not
      ...
      approved by us in writing under separate contractual authorization. ‍ As a
      user of the Site, you agree not to: Systematically retrieve data or other
      ...
      harm, in our opinion, us and/or the Site. Use any information obtained
      from the Site in order to harass, abuse, or harm another person. Make
      improper use of our support services or submit false reports of abuse or
      misconduct. Use the Site in a manner inconsistent with any applicable laws
      or regulations. Engage in unauthorized framing of or linking to the Site.
      ...
      (including Third Party Content as defined below). Attempt to impersonate
      ...
      on the Site. Make any unauthorized use of the Site, including collecting
      ...
      any revenue-generating endeavor or commercial enterprise. Use the Site to
      advertise or offer to sell goods and services, except as may be authorized
      by us. The Site does not offer users to submit or post content. We may
      ...
      treated in accordance with our Privacy Policy. When you create or make
      ...
      or regulation. Any use of the Site in violation of the foregoing violates
      these Terms of Use and may result in, among other things, termination or
      suspension of your rights to use the Site. ‍ You agree that we may access,
      store, process, and use any information and personal data that you provide
      following the terms of our Privacy Policy and your choices related thereto
      (including settings). ‍ By submitting suggestions or other feedback
      regarding the Site, you agree that we can use and share such feedback for
      any purpose without compensation to you. ‍ We do not assert any ownership
      over your Contributions, except to the extent that content included within
      such Contributions is considered a Submission as defined below. We are not
      ...
      against us regarding your Contributions. ‍ You acknowledge and agree that
      ...
      non-confidential. As between us, Company shall own exclusive rights,
      including all intellectual property rights, and shall be entitled to the
      unrestricted use, modification and dissemination of these Submissions for
      any lawful purpose, commercial or otherwise, without acknowledgment or
      compensation to you. Further, and to the extent that any of Your
      Submissions may be subject to copyright protection, You hereby grant to
      Company and to any recipients of software distributed by Company, a
      perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable
      copyright license to reproduce, prepare derivative works of, publicly
      display, publicly perform, sublicense, and distribute Your Contributions
      and any derivative works therefrom. You hereby waive all moral rights to
      ...
      Submissions. ‍ The Site may contain (or you may be sent via the Site)
      ...
      or installed from the Site, nor any content, accuracy, offensiveness,
      ...
      endorsement by us. If you decide to leave the Site and access the
      Third-Party Websites or to use or install any Third-Party Content, you do
      so at your own risk, and these Terms of Use no longer govern your use of
      such Third Party Websites. You should review the applicable terms and
      ...
      contact with Third-Party Websites ‍ We reserve the right, but not the
      obligation, to: (1) monitor the Site for violations of these Terms of Use;
      ...
      size or are in any way burdensome to our systems; and (5) otherwise manage
      ...
      and processed in United States. ‍ These Terms of Use shall remain in full
      ...
      SITE (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY
      ...
      limitation pursuing civil, criminal, and injunctive redress. ‍ We reserve
      ...
      connection therewith. ‍ These Terms of Use and your use of the Site are
      governed by and construed in accordance with the laws of the State of
      Washington, United States applicable to agreements made and to be entirely
      ...
      Party. ‍ Disclaimer and Limitation of Our Liability There may be
      information on the Site that contains typographical errors, inaccuracies,
      or omissions, including descriptions, pricing, availability, and various
      ...
      Site at any time, without prior notice. ‍ THE SITE IS PROVIDED ON AN AS-IS
      ...
      SERVICES. ‍ IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE
      ...
      THE ACTION, WILL AT ALL TIMES BE LIMITED TO ONE THOUSAND US DOLLARS
      ($1,000.00). CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
      ...
      which is subject to this indemnification upon becoming aware of it. ‍ We
      ...
      or corruption of such data. ‍ Visiting the Site, sending us emails, and
      ...
      granting of credits by any means other than electronic means to the extent
      applicable. If any complaint with us is not satisfactorily resolved, you
      ...
      telephone at (800) 952-5210 or (916) 445-1254. ‍ These Terms of Use and
      ...
      lack of signing by the parties hereto to execute these Terms of Use. ‍ In
      order to resolve a complaint regarding the Site or to receive further
      information regarding use of the Site, please contact us at: GenSX, Inc.
      Address: 113 Cherry St., PMB 30368, Seattle WA, 98104 Phone: (501)
      387-0843 Email: contact@GenSX.com
    </div>
  );
}
