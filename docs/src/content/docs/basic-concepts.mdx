...
Components can also return structured objects containing other components. The pattern works with array operations like `map` for processing items in parallel.
