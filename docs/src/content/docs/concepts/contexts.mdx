...
The two concepts are interdependent so you can't use one without the other. The remainder of this document will show you how to create and use both contexts and providers in GenSX.
