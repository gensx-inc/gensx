      ...
      <div className="space-y-6 text-slate-700">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="text-xs bg-slate-100/50 rounded-lg p-3">
              <div className="font-medium text-slate-800">
                &ldquo;Show me Paris and tell me about the Eiffel Tower&rdquo;
              </div>
              <div className="text-slate-600 mt-1">
                I&rsquo;ll navigate to Paris and add a marker with information
              </div>
            </div>

            <div className="text-xs bg-slate-100/50 rounded-lg p-3">
              <div className="font-medium text-slate-800">
                &ldquo;Find the best restaurants in Tokyo&rdquo;
              </div>
              <div className="text-slate-600 mt-1">
                I&rsquo;ll search for restaurants and place markers on the map
              </div>
            </div>

            <div className="text-xs bg-slate-100/50 rounded-lg p-3">
              <div className="font-medium text-slate-800">
                &ldquo;What&rsquo;s the weather like in New York?&rdquo;
              </div>
              <div className="text-slate-600 mt-1">
                I&rsquo;ll search for current weather and show NYC on the map
              </div>
            </div>

            <div className="text-xs bg-slate-100/50 rounded-lg p-3">
              <div className="font-medium text-slate-800">
                &ldquo;Clear all markers and show me London&rdquo;
              </div>
              <div className="text-slate-600 mt-1">
                I&rsquo;ll clean the map and navigate to a new location
              </div>
            </div>
          </div>
        </div>
