...
const components: Partial<Components> = {
  ...
  h3({ children }) {
    return (
      <h3 className="text-lg font-semibold mt-3 mb-2 text-slate-900">
        {children}
      </h3>
    );
  },
  h4({ children }) {
    return (
      <h4 className="text-base font-semibold mt-3 mb-2 text-slate-900">
        {children}
      </h4>
    );
  },
  h5({ children }) {
    return (
      <h5 className="text-sm font-semibold mt-3 mb-2 text-slate-900">
        {children}
      </h5>
    );
  },
  h6({ children }) {
    return (
      <h6 className="text-xs font-semibold mt-3 mb-2 text-slate-900">
        {children}
      </h6>
    );
  },
