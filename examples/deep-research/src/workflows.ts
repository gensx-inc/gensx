...
@gensx.Component()
export async function CreateReport({ results, prompt }: CreateReportProps): Promise<string> {
...
@gensx.Component()
export async function Research({ queries, prompt }: ResearchProps): Promise<ArxivSummary[]> {
  console.log("\n=== Queries ===");
...
@gensx.Workflow()
export async function DeepResearch({ prompt }: DeepResearchProps): Promise<string> {
