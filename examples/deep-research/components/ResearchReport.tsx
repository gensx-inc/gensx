      ...
      <div className="pl-12 pr-2 py-2">
        <div className="px-3">
          <div className="flex items-center gap-2 mb-4 pb-3 border-b border-zinc-700">
            <h4
              className={`font-medium text-sm ${isActive ? "bg-gradient-to-r from-zinc-400 via-zinc-600 to-zinc-400 bg-clip-text text-transparent bg-[length:100%_200%] animate-[shimmer_4s_linear_infinite]" : "text-zinc-400"}`}
            >
