...
import { ChatState } from "@/workflows/workflows";
...
export default function ChatPage() {
  ...
  const {
    ...
    // isComplete,
    // executionId,
  } = useWorkflowWithState<{ userInput: string; threadId: string }, ChatState>(
    "/ChatMemoryWorkflow",
    "ChatState",
  );
  ...
  useEffect(() => {
    scrollToBottom();
    console.log("workflowState?.messages", state?.messages);
  }, [state?.messages]);
