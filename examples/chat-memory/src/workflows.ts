...
@gensx.Component()
async function ChatWithMemory({ userInput, threadId }: { userInput: string; threadId: string }) {
...
@gensx.Workflow()
export async function ChatMemoryWorkflow({ userInput, threadId }: { userInput: string; threadId: string }) {
