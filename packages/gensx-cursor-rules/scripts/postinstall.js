...
if (process.env.NODE_ENV === 'production') {
  console.log('Skipping GenSX cursor rules installation in production environment.');
  process.exit(0);
}
...
async function copyRules() {
  try {
    ...
    console.log('You can manually copy the rules from node_modules/@gensx/cursor-rules/rules to your project\'s .cursor directory.');
  }
}
