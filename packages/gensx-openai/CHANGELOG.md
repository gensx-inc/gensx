...
## [0.1.6](https://github.com/gensx-inc/gensx/compare/gensx-openai-v0.1.5...gensx-openai-v0.1.6) (2025-02-01)
...
* The following workspace dependencies were updated
  * devDependencies
    * gensx bumped to 0.2.9
  * peerDependencies
    * gensx bumped from >=0.2.1 to >=0.2.9
